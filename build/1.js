    ...
    ThankyouPage.prototype.showForm = function () {
        var alert = this.alertCtrl.create({
            ...
            '<div class="alert-align-center"><img class="img-alert" src="assets/imgs/person3a.png"/></div>'
                ...
                + '<div text-center>Por favor, nos ajude a avaliar a <strong>usabilidade do aplicativo</strong> respondendo o <strong>formulário: <a style="font-size:1.5rem" href="https://forms.gle/Z8RVkQvHitHyjrwGA"><strong>Avaliação da usabilidade</strong></a></div>'
                + '<div text-center></div>'
                + '</div></div>',
            //----------------------MENSAGEM------------------
            buttons: [{
