...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 14-Abr-2020 às 03:23
...
CREATE TABLE IF NOT EXISTS `respondent` (
  ...
  `job_name` text COLLATE latin1_general_ci,
  `job_address` text COLLATE latin1_general_ci,
  ...
  KEY `residence_city_id` (`residence_city_id`)
...
INSERT INTO `respondent` (`id`, `cpf`, `code`, `name`, `email`, `gender`, `phone`, `whatsapp`, `age_range`, `salary_range`, `residence_time_range`, `residence_city_id`, `residence_neighborhood_id`, `job_name`, `job_address`, `job_city_id`, `job_neighborhood_id`, `course_name`, `course_entry`, `points`, `type`, `case_test`, `created_at`, `updated_at`) VALUES
(29, '110.179.676-61', NULL, 'kayque', 'kayque@email.com', 'Masculino', '(35)98447-8682', NULL, 2, 2, 2, NULL, 247, NULL, NULL, 6, NULL, '', NULL, NULL, 'cidadão', NULL, '2020-01-20 17:26:35', '2020-04-04 16:00:50'),
(45, '110.179.676-60', '355555', 'kkkkk', 'kayque@email.com', 'Feminino', '(35)88888-88888', '(35)88888-88888', 2, 2, 2, 6, 247, 'kkkkkkkkkkkkkkkkk', 'kkkkkkkkkkkkkkkkkkkk', 6, NULL, NULL, NULL, 51, 'Docente Pós-Graduação', 'POSCOMP', '2020-04-14 02:51:44', '2020-04-14 02:53:47');
...
ALTER TABLE `respondent`
  ...
  ADD CONSTRAINT `respondent_ibfk_4` FOREIGN KEY (`residence_city_id`) REFERENCES `city` (`id`);
COMMIT;
