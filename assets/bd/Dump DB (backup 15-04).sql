...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 15-Abr-2020 às 05:37
...
(153, '1. A secretaria funciona dentro dos horários previstos?', '', '1. A secretaria funciona dentro dos horários previstos?', 1, 'Avaliação POSCOMP - Secretaria', 'logo-unifei.png', 0, 20, '', 0, 0, 1),
(154, '2. A secretaria atende com urbanidade o público?', '', '2. A secretaria atende com urbanidade o público?', 2, 'Avaliação POSCOMP - Secretaria', 'logo-unifei.png', 0, 20, '', 0, 0, 1),
(155, '3. O contato com a secretaria por meio eletrônico é satisfatório?', '', '3. O contato com a secretaria por meio eletrônico é satisfatório?', 3, 'Avaliação POSCOMP - Secretaria', 'logo-unifei.png', 0, 20, '', 0, 0, 1),
...
(157, '5. Os procedimentos da secretaria são céleres e adequados?', '', '5. Os procedimentos da secretaria são céleres e adequados?', 5, 'Avaliação POSCOMP - Secretaria', 'logo-unifei.png', 0, 20, '', 0, 0, 1),
(158, '6. Indique no espaço abaixo os serviços que a secretaria pode melhorar.', '', '6. Indique no espaço abaixo os serviços que a secretaria pode melhorar. ', 6, 'Avaliação POSCOMP - Secretaria', 'logo-unifei.png', 0, 0, '', 0, 1, 0),
(159, '1. Como você avalia o suporte da coordenação em relação às diversas demandas surgidas ao longo de 2019?', '', '1. Como você avalia o suporte da coordenação em relação às diversas demandas surgidas ao longo de 2019?', 1, 'Avaliação POSCOMP - Coordenação', 'logo-unifei.png', 0, 21, '', 0, 0, 1),
...
(161, '3. Como você avalia a sua interação com a coordenação do programa?', '', '3. Como você avalia a sua interação com a coordenação do programa?', 3, 'Avaliação POSCOMP - Coordenação', 'logo-unifei.png', 0, 21, '', 0, 0, 1),
...
(163, '5. Os procedimentos da coordenação são céleres e adequados?', '', '5. Os procedimentos da coordenação são céleres e adequados?', 5, 'Avaliação POSCOMP - Coordenação', 'logo-unifei.png', 0, 21, '', 0, 0, 1),
...
(166, '2. De forma geral, considera que o Curso foi relevante para seu crescimento acadêmico e profissional?', '', '2. De forma geral, considera que o Curso foi relevante para seu crescimento acadêmico e profissional?', 2, 'Avaliação POSCOMP - Discentes Egressos', 'logo-unifei.png', 0, 20, '', 0, 0, 1),
(167, '3. Indique no espaço abaixo sugestões para melhoria do POSCOMP.', '', '3. Indique no espaço abaixo sugestões para melhoria do POSCOMP.', 3, 'Avaliação POSCOMP - Discentes Egressos', 'unifei-logo.png', 0, 0, '', 0, 1, 0),
(168, '4. Comente as razões para você ter desistido do curso:', '', '4. Comente as razões para você ter desistido do curso:', 4, 'Avaliação POSCOMP - Evasão', 'logo-unifei.png', 0, 0, '', 0, 1, 0),
...
INSERT INTO `respondent` (`id`, `cpf`, `code`, `name`, `email`, `gender`, `phone`, `whatsapp`, `age_range`, `salary_range`, `residence_time_range`, `residence_city_id`, `residence_neighborhood_id`, `job_name`, `job_address`, `job_city_id`, `job_neighborhood_id`, `course_name`, `course_entry`, `course_left`, `points`, `type`, `case_test`, `created_at`, `updated_at`) VALUES
(1, '110.179.676-61', NULL, 'kayque', 'kayque@email.com', 'Masculino', '(35)98447-8682', NULL, 2, 2, 2, NULL, 247, NULL, NULL, 6, NULL, '', NULL, NULL, NULL, 'cidadão', NULL, '2020-01-20 17:26:35', '2020-04-04 16:00:50'),
(7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2º semestre - 2010', NULL, NULL, 'Discente', 'POSCOMP', '2020-04-15 02:27:14', NULL),
(8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1º semestre - 2011', NULL, 23, 'Discente', 'POSCOMP', '2020-04-15 02:47:25', NULL),
(9, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Docente', 'POSCOMP', '2020-04-15 05:03:28', NULL),
(10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Docente', 'POSCOMP', '2020-04-15 05:15:38', NULL);
